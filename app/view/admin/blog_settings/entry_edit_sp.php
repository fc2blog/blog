...
<form method="POST" id="sys-blog-template-form" class="admin-form">
  <div class="form_area">
    <div class="form_contents">
      ...
      <div class="common_input_text"><?php echo \Fc2blog\Web\Html::input($request, 'blog_setting[entry_recent_display_count]', 'text'); ?></div>
    ...
    <div class="form_contents">
      ...
      <div class="common_input_text"><?php echo \Fc2blog\Web\Html::input($request, 'blog_setting[entry_display_count]', 'text'); ?></div>
      ...
      <?php echo \Fc2blog\Web\Html::input($request, 'blog_setting[entry_order]', 'select', array('options'=>\Fc2blog\Model\BlogSettingsModel::getEntryOrderList())); ?>
    ...
    <div class="form_contents">
      ...
      <div class="common_input_text"><?php echo \Fc2blog\Web\Html::input($request, 'blog_setting[entry_password]', 'text'); ?></div>
