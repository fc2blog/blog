...
<table>
  <tbody>
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input($request, 'entry[title]', 'text'); ?>
  ...
  <div>
    <?php echo \Fc2blog\Web\Html::input($request, 'entry[body]', 'textarea', array('id'=>'sys-entry-body')); ?>
  ...
  <div <?php if(\Fc2blog\Web\Cookie::get('js_entry_hide_extend')){echo 'style="visibility: hidden;"';} ?>>
    <?php echo \Fc2blog\Web\Html::input($request, 'entry[extend]', 'textarea', array('id'=>'sys-entry-extend')); ?>
    ...
    <table>
      <tbody>
        <tr>
          ...
          <td>
            <?php echo \Fc2blog\Web\Html::input($request, 'entry[posted_at]', 'text', array('class'=>'date-time-picker')); ?>
        ...
        <tr>
          ...
          <td>
            <?php echo \Fc2blog\Web\Html::input($request, 'entry[open_status]', 'radio', array('options'=>\Fc2blog\Model\EntriesModel::getOpenStatusList(), 'default'=>\Fc2blog\Config::get('ENTRY.OPEN_STATUS.OPEN'))); ?>
        ...
        <tr>
          ...
          <td class="sys-entry-password">
            <?php echo \Fc2blog\Web\Html::input($request, 'entry[password]', 'text'); ?>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td>
            <?php echo \Fc2blog\Web\Html::input($request, 'entry[comment_accepted]', 'radio', array('options'=>\Fc2blog\Model\EntriesModel::getCommentAcceptedList(), 'default'=>\Fc2blog\Config::get('ENTRY.COMMENT_ACCEPTED.ACCEPTED'))); ?>
