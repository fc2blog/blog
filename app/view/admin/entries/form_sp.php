...
<div class="form_area">
  <div class="form_contents common_input_text">
    <!--<?php echo __('Title'); ?>-->
    <?php echo \Fc2blog\Web\Html::input('entry[title]', 'text', array('placeholder'=>__('Article Title'))); ?>
...
<div class="content_wrap" style="display: block;">
    <div class="edit_area_box"><?php echo \Fc2blog\Web\Html::input('entry[body]', 'textarea', array('id'=>'sys-entry-body','placeholder'=>__('Body'))); ?></div>
...
<div class="content_wrap nondisplay" style="display: none; ">
  <div class="edit_area_box"><?php echo \Fc2blog\Web\Html::input('entry[extend]', 'textarea', array('id'=>'sys-entry-extend','placeholder'=>__('Edit a postscript'))); ?></div>
  ...
  <div class="accordion_inner" style="display: none;">
    <div class="form_area">
      ...
      <div class="form_contents">
        <div class="radio_vertical_box">
          <?php echo \Fc2blog\Web\Html::input('entry[open_status]', 'radio', array('options'=>\Fc2blog\Model\EntriesModel::getOpenStatusList(), 'default'=>\Fc2blog\Config::get('ENTRY.OPEN_STATUS.OPEN'),'class'=>'radio_vertical_input')); ?>
    ...
    <div class="form_area">
      ...
      <div class="form_contents">
        ...
        <?php echo \Fc2blog\Web\Html::input('entry[posted_at]', 'hidden'); ?>
    ...
    <div class="form_area">
      ...
      <div class="form_contents">
        <div class="radio_horizontal_box">
          <?php echo \Fc2blog\Web\Html::input('entry[comment_accepted]', 'radio', array('options'=>\Fc2blog\Model\EntriesModel::getCommentAcceptedList(), 'default'=>\Fc2blog\Config::get('ENTRY.COMMENT_ACCEPTED.ACCEPTED'),'class'=>'common_input_radio')); ?>
        </div>
