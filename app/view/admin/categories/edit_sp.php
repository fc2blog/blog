...
<form method="POST" class="admin-form">
  ...
  <div class="form_area">
    ...
    <div class="form_contents">
      ...
      <div class="common_input_text"><?php echo \Fc2blog\Web\Html::input($request, 'category[name]', 'text'); ?></div>
...
<div class="btn_area">
  <ul class="btn_area_inner">
    <li>
      <a class="btn_contents touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Categories','action'=>'create')); ?>"><i class="return_icon btn_icon"></i><?php echo __('I Back to List'); ?></a>
    </li>
