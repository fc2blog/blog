<header><h2><?php echo __('User registration'); ?></h2></header>
...
<table id="id_form">
  <tbody>
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('user[login_id]', 'text'); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[id]', 'text'); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[name]', 'text'); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[nickname]', 'text'); ?>
