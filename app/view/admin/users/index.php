  ...
  <table>
    ...
    <?php foreach ($blogs as $blog) : ?>
      <tr>
        ...
        <td style="width: 120px;"><a href="<?php echo \Fc2blog\Model\BlogsModel::getFullHostUrlByBlogId($blog['id'], \Fc2blog\Config::get('DOMAIN_USER')); ?><?php echo \Fc2blog\Web\Html::url(array('controller'=>'Entries', 'action'=>'index', 'blog_id'=>$blog['id'])); ?>" target="_blank"><?php echo __('Checking the blog'); ?></a></td>
      </tr>
    <?php endforeach; ?>
  </table>
<?php endforeach; ?>
