  ...
  <footer id="site_footer">
      ...
      <?php if ($this->isLogin()): ?>
        ...
        <?php if ($this->isSelectedBlog()) : ?>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, 'common/notice')) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Common','action'=>'notice')); ?>"><span><i class="sidemenu_home"></i></span><span><?php echo __('Notice'); ?></span></a></li>
            ...
            <li <?php if (\Fc2blog\App::isActiveMenu($request, array('entries/create', 'entries/edit'))) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Entries','action'=>'create')); ?>"><span><i class="sidemenu_editor"></i></span><span><?php echo __('New article'); ?></span></a></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, 'entries/index')) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Entries', 'action'=>'index')); ?>"><span><i class="sidemenu_entry"></i></span><span><?php echo __('List of articles'); ?></span></a></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, array('comments/index', 'comments/reply'))) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Comments', 'action'=>'index')); ?>"><span><i class="sidemenu_comment"></i></span><span><?php echo __('List of comments'); ?></span></a></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, array('files/upload', 'files/edit'))) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Files', 'action'=>'upload')); ?>"><span><i class="sidemenu_file"></i></span><span><?php echo __('Upload file'); ?></span></a></li>
        <?php endif; ?>
        <?php if ($this->isSelectedBlog()) : ?>
            <li class="list_titile"><?php echo __('Setting'); ?></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, 'blog_templates/index')) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'BlogTemplates', 'action'=>'index', 'device_type'=>\Fc2blog\Config::get('DEVICE_SP'))); ?>"><span><i class="sidemenu_template"></i></span><span><?php echo __('Template management'); ?></span></a></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, 'blog_plugins/index')) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'blog_plugins', 'action'=>'index', 'device_type'=>\Fc2blog\Config::get('DEVICE_SP'))); ?>"><span><i class="sidemenu_plugin"></i></span><span><?php echo __('Plugin management'); ?></span></a></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, array('categories/create', 'categories/edit'))) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Categories','action'=>'create')); ?>"><span><i class="sidemenu_category"></i></span><span><?php echo __('Category management'); ?></span></a></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, array('tags/index', 'tags/edit'))) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Tags', 'action'=>'index')); ?>"><span><i class="sidemenu_tag"></i></span><span><?php echo __('List of tags'); ?></span></a></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, array('blogs/edit', 'blog_settings/entry_edit', 'blog_settings/comment_edit', 'blog_settings/etc_edit', 'blogs/delete'))) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Blogs', 'action'=>'edit')); ?>"><span><i class="sidemenu_setting"></i></span><span><?php echo __('Blog setting'); ?></span></a></li>
        <?php endif; ?>
          </ul>
        </div>
      <?php else: ?>
        <div id="left_menu" class="sidemenu">
          <ul>
            <?php if (\Fc2blog\Config::get('USER.REGIST_SETTING.FREE') == \Fc2blog\Config::get('USER.REGIST_STATUS')): ?>
              <li <?php if (\Fc2blog\App::isActiveMenu($request, 'users/register')) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Users', 'action'=>'register')); ?>"><span><i class="sidemenu_editor"></i></span><span><?php echo __('User registration'); ?></span></a></li>
            <?php endif; ?>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, 'users/login')) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Users', 'action'=>'login')); ?>"><span></span><span><?php echo __('Login'); ?></span></a></li>
          </ul>
        </div>
      <?php endif; ?>
  ...
  <?php if ($this->isLogin()): ?>
      <div id="right_menu" class="sidemenu">
        <ul>
            ...
            <li <?php if (\Fc2blog\App::isActiveMenu($request, 'blogs/index')) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Blogs', 'action'=>'index')); ?>"><span><i class="sidemenu_myblog"></i></span><span><?php echo __('List of blogs'); ?></span></a></li>
            <li <?php if (\Fc2blog\App::isActiveMenu($request, array('users/edit', 'users/withdrawal'))) echo 'class="selected"'; ?>><a class="touch" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Users', 'action'=>'edit')); ?>"><span><i class="sidemenu_setting"></i></span><span><?php echo __('User setting'); ?></span></a></li>
          ...
          <?php endforeach; ?>
          <li <?php if (\Fc2blog\App::isActiveMenu($request, 'blogs/create')) echo 'class="selected"'; ?>><a href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Blogs', 'action'=>'create')); ?>"><span><i class="sidemenu_myblog"></i></span><span><?php echo __('Create a new blog'); ?></span></a></li>
        </ul>
      </div>
  <?php endif; ?>
</div><!--#wrapper_all-->
