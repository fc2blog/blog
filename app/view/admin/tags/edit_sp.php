...
<div class="btn_area">
  <ul class="btn_area_inner">
    <li>
      <a class="btn_contents touch" href="<?php if($request->isArgs('back_url')): ?><?php echo $request->get('back_url'); ?><?php else: ?><?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'Tags', 'action'=>'index')); ?><?php endif; ?>"><i class="return_icon btn_icon"></i><?php echo __('I Back to List'); ?></a>
    </li>
    <li>
...
<div class="btn_area"><ul class="btn_area_inner"><li>
  <a href="<?php echo \Fc2blog\Web\Html::url($request, array('action'=>'delete', 'id'=>$request->get('id'), 'back_url'=>ue($request->get('back_url')), 'sig'=>\Fc2blog\Web\Session::get('sig'))); ?>" class="btn_contents touch"
