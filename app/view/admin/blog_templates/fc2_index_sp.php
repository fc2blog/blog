...
<?php if (!empty($templates)): ?>
  ...
  <?php foreach ($templates as $template) : ?>
        <li class="template_list_item">
          <a href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'blog_templates', 'action'=>'fc2_view', 'fc2_id'=>$template['id'], 'device_type'=>$request->get('device_type'))); ?>">
...
<!--<?php echo __('Summary'); ?> : <?php echo $template['discription']; ?>
        ...
        <a class="admin_common_btn create_btn" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'blog_templates', 'action'=>'download', 'fc2_id'=>$template['id'], 'device_type'=>$request->get('device_type'))); ?>"><?php echo __('Download'); ?></a>-->
  <?php endforeach; ?>
  </ul>
<?php else: ?>
