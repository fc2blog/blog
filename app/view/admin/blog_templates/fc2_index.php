  ...
  <?php foreach ($templates as $template) : ?>
    <table class="templates"><tbody>
      ...
      <tr><td class="btn">
        ...
        <a class="admin_common_btn create_btn" href="<?php echo \Fc2blog\Web\Html::url($request, array('controller'=>'blog_templates', 'action'=>'create', 'fc2_id'=>$template['id'], 'device_type'=>$request->get('device_type'), 'sig'=>\Fc2blog\Web\Session::get('sig'))); ?>"><?php echo __('Download'); ?></a>
      </td></tr>
    </tbody></table>
  <?php endforeach; ?>
<?php else: ?>
