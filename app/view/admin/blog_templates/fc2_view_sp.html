...
<div class="template_detail ">
  ...
  <div class="right_column">
    <p>
      <a  class="btn_contents touch" href="<?php echo \Fc2blog\App::userURL(array('controller'=>'Entries', 'action'=>'preview', 'blog_id'=>$this->getBlogId(), 'fc2_id'=>$template['id'], 'device_type'=>$request->get('device_type')), false, true); ?>" target="_blank"><?php echo __('Preview'); ?></a>
    </p>
    <p>
  ...
  <p class="output_contents"><?php echo $template['name']; ?></p>
  <h3><span class="h3_inner"><?php echo __('Summary'); ?></span></h3>
  <p class="output_contents"><?php echo $template['discription']; ?></p>
  <div class="btn_area">
