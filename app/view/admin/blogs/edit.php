...
<table>
  <tbody>
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[name]', 'text', array('maxlength'=>255)); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[introduction]', 'text', array('maxlength'=>200)); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[nickname]', 'text', array('maxlength'=>255)); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[open_status]', 'select', array('options'=>\Fc2blog\Model\BlogsModel::getOpenStatusList())); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[blog_password]', 'text'); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[timezone]', 'select', array('options'=>\Fc2blog\Model\BlogsModel::getTimezoneList())); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[ssl_enable]', 'select', array('options'=>\Fc2blog\Model\BlogsModel::getSSLEnableSettingList())); ?>
    ...
    <tr>
      ...
      <td>
        <?php echo \Fc2blog\Web\Html::input('blog[redirect_status_code]', 'select', array('options'=>\Fc2blog\Model\BlogsModel::getRedirectStatusCodeSettingList())); ?>
