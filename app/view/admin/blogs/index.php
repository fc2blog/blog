...
<div class="right mb10"><a class="admin_common_btn create_btn" href="<?php echo \Fc2blog\Web\Html::url(array('controller'=>'Blogs', 'action'=>'create')); ?>"><?php echo __('Create a new blog'); ?></a></div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="<?php echo \Fc2blog\Web\Html::url(array('action'=>'choice', 'blog_id'=>$blog['id'])); ?>"><?php echo th($blog['name'], 20); ?></a></td>
