...
<form method="POST" class="admin-form">
  <div class="form_area">
    ...
    <div class="form_contents">
      ...
      <div class="common_input_text"><?php echo \Fc2blog\Web\Html::input('blog[introduction]', 'text'); ?></div>
    ...
    <div class="form_contents">
      ...
      <div class="common_input_text"><?php echo \Fc2blog\Web\Html::input('blog[blog_password]', 'text'); ?></div>
