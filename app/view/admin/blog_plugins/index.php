...
<div id="sys-index">
  <?php foreach($category_blog_plugins as $category => $blog_plugins): ?>
    ...
    <p class="header_btn">
      <a class="admin_common_btn create_btn" href="<?php echo \Fc2blog\Web\Html::url(array('controller'=>'BlogPlugins','action'=>'official_search', 'device_type'=>$device_type, 'category'=>$category)); ?>"><?php echo __('Official Plugin Search'); ?></a>
      <a class="admin_common_btn create_btn" href="<?php echo \Fc2blog\Web\Html::url(array('controller'=>'BlogPlugins','action'=>'share_search', 'device_type'=>$device_type, 'category'=>$category)); ?>"><?php echo __('Share Plugin Search'); ?></a>
      <a class="admin_common_btn create_btn" href="<?php echo \Fc2blog\Web\Html::url(array('controller'=>'BlogPlugins','action'=>'create', 'device_type'=>$device_type, 'category'=>$category)); ?>"><?php echo __('Plugin Creation'); ?></a>
    </p>
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        <?php foreach($blog_plugins as $blog_plugin): ?>
          <tr>
            <td>
              <a href="<?php echo \Fc2blog\Web\Html::url(array('action'=>'edit', 'id'=>$blog_plugin['id'])); ?>"><?php echo th($blog_plugin['title'], 20); ?></a>
            </td>
            ...
            <td class="center">
              <a href="<?php echo \Fc2blog\Web\Html::url(array('action'=>'register', 'id'=>$blog_plugin['id'])); ?>"><?php if($blog_plugin['plugin_id']): ?><?php echo __('Update'); ?><?php else: ?><?php echo __('Register'); ?><?php endif; ?></a>
            </td>
            <td class="center s_cell">
              <a href="<?php echo \Fc2blog\Web\Html::url(array('action'=>'delete', 'id'=>$blog_plugin['id'], 'sig'=>\Fc2blog\Web\Session::get('sig'))); ?>" onclick="return confirm('<?php echo __('Are you sure you want to delete?'); ?>');"><?php echo __('Delete'); ?></a>
            </td>
          </tr>
        <?php endforeach; ?>
      </tbody>
...
<?php $json = array(); ?>
<form action="<?php echo \Fc2blog\Web\Html::url(array('controller'=>'blog_plugins', 'action'=>'sort')); ?>" method="POST" id="sys-order" style="display: none;">
  <?php foreach($category_blog_plugins as $category => $blog_plugins): ?>
    <h3><?php echo __('Category'); ?><?php echo $category; ?></h3>
