...
<form method="POST" id="sys-blog-plugin-form" class="admin-form">
  ...
  <div class="form-button btn_area">
    ...
    <ul class="btn_area_inner">
      <li>
        <a class="btn_contents touch" href="<?php echo \Fc2blog\Web\Html::url(array('controller'=>'blog_plugins', 'action'=>'index', 'device_type'=>\Fc2blog\Config::get('DEVICE_SP'))); ?>"><i class="return_icon btn_icon"></i><?php echo __('I Back to List'); ?></a>
      </li>
    </ul>
  </div>
</form>
