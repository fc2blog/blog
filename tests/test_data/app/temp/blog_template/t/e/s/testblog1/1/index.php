...
?>"><?php if(isset($entry['title'])) echo $entry['title']; ?></a></li><?php } ?>
        ...
        <div class="content plg">
          <h3 class="plg_header" style="text-align:<?php if(isset($t_plugin['title_align'])) echo $t_plugin['title_align']; ?>"><?php if(isset($t_plugin['title'])) echo $t_plugin['title']; ?></h3>
          <!--plugin_third_description--><div class="plg_description" style="text-align:"></div><!--/plugin_third_description-->
          <div class="plg_body" style="text-align:<?php if(isset($t_plugin['contents_align'])) echo $t_plugin['contents_align']; ?>"><?php if(isset($t_plugin['id'])) include(\Fc2blog\App::getPluginFilePath($blog_id, $t_plugin['id'])); ?></div>
