...
elRTE = function(target, opts) {
	...
	.bind('keydown', function(e) {
		if ((e.metaKey || e.ctrlKey) && e.keyCode == 65) {
			...
			if (self.dom.selfOrParent(n, /^PRE$/)) {
				...
				return false;
			} else if (/* Jquery ver up patch $.browser.safari */false && e.shiftKey) {
	...
	if (/* Jquery ver up patch $.browser.safari */false) {
...
elRTE.prototype.ui.prototype.buttons.fullscreen = function(rte, name) {
	...
	this.command = function() {
		var w = $(window),
			...
			m = /* Jquery ver up patch $.browser.mozilla */false,
			b, h;
...
elRTE.prototype.ui.prototype.buttons.link = function(rte, name) {
	...
	this.command = function() {
		...
		opts = {
			...
			close : function() { /* REMOVE IE SUPPORT PATCH self.rte.browser.msie */ false && self.rte.selection.restoreIERange(); },
			dialog : {
				width : 'auto',
				width : 430,
...
elRTE.prototype.ui.prototype.buttons.pastetext = function(rte, name) {
	...
	this.command = function() {
		/* REMOVE IE SUPPORT PATCH self.rte.browser.msie */false && this.rte.selection.saveIERange();
		var opts = {
			submit : function(e, d) {
				e.stopPropagation();
				e.preventDefault();
	...
	this.paste = function() {
		...
		if (txt) {
			this.rte.history.add();
			/* REMOVE IE SUPPORT PATCH self.rte.browser.msie */false && this.rte.selection.restoreIERange();
